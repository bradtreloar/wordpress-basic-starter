    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
    {
        ...
        if (isset($args->has_children) && $args->has_children && 0 === $depth) {
            ...
            if ($depth > 0) {
                ...
                $atts['class'] = 'nav-link';
                if ($args->theme_location == 'contact_menu') {
                    $atts['class'] .= ' btn btn-outline-light px-3';
                }
            }
        }
        ...
        /*
            ...
            * icon classes form the icon markup with an <svg> element. This is
            * output inside of the item before the $title (the link text).
            */
        $icon_html = '';
        if (substr($atts['href'], 0, 4) == 'tel:') {
            // Append an <i> with the icon classes to what is output before links.
            $icon_html = '<svg class="icon mr-lg-1" height="16" width="16" aria-hidden="true"><use xlink:href="#phone" /></svg> ';
        }
        ...
        */
        ...
        if ($args->theme_location == 'contact_menu' && substr($atts['href'], 0, 4) == 'tel:') {
            $label = '<span class="d-none d-lg-inline">' . $title . '</span>';
        }
        ...
        $item_output .= isset($args->link_before) ? $args->link_before . $icon_html . $label . $args->link_after : '';
